...
@enum(
  FTBitMode,
  MODE_RESET = Integer(FT_MODE_RESET),
  MODE_ASYNC_BITBANG = Integer(FT_MODE_ASYNC_BITBANG),
  MODE_MPSSE = Integer(FT_MODE_MPSSE),
  MODE_SYNC_BITBANG = Integer(FT_MODE_SYNC_BITBANG),
  MODE_MCU_EMULATION = Integer(FT_MODE_MCU_EMULATION),
  MODE_FAST_OPTO = Integer(FT_MODE_FAST_OPTO),
  MODE_CBUS_BITBANG = Integer(FT_MODE_CBUS_BITBANG),
  MODE_SCS_FIFO = Integer(FT_MODE_SCS_FIFO))
